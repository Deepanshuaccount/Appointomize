  ...
  return (
    <>
      ...
      <div className="contact-text">
        ...
        <p>Personalized Solutions: Custom pricing for your specific requirements.
          Expert Consultation: Get the best solutions from our team.
          Flexible Packages: Choose a plan that grows with your business. </p>
          <h3>Get in Touch:</h3>
        <p>Fill out the form below, and we’ll get back to you within 24 hours. </p>
        <h4>Or reach us directly at:</h4>
        <h4>Email: info@appointimize.com </h4>
        <h4>Phone: +91 96505 83832</h4>
        <h4>Office Hours: Monday to Friday, 9 AM - 6 PM</h4>
      </div>
